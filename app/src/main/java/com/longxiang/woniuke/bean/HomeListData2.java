...
public class HomeListData2 {
    ...
    public HomeListData2(String uid, String sumtiems, double level, String time, String starchar, double distance, String age, String head_pic, String nickname, String sex, List<String> godpic) {
        this.uid = uid;
