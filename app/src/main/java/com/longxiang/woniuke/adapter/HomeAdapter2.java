...
//    private List<ImageView> imgs;
    private List<HomeListData2> datas;
    ImageOptions imageOptions = new ImageOptions.Builder()
            ...
            .setSquare(true)
            .build();
//    String [] colors={"#FF0000","#FFA500","#FFFF00","#00FF00","#007FFF","#0000FF","#8B00FF"};
    public HomeAdapter2(Context context, List<HomeListData2> datas) {
...
//
        ...
        HomeListData2 data=datas.get(position);
//        tv1.setTextColor(context.getResources().getColor(R.color.colorWorddark));
//        tv4.setTextColor(context.getResources().getColor(R.color.colorWorddark));
//        tv5.setTextColor(context.getResources().getColor(R.color.colorWorddark));
//        tv7.setTextColor(context.getResources().getColor(R.color.colorWorddark));
//        tv2.setTextColor(context.getResources().getColor(R.color.colorWordlight));
//        tv3.setTextColor(context.getResources().getColor(R.color.colorWordlight));
//        tv6.setTextColor(context.getResources().getColor(R.color.colorWordlight));
        holder.tv1.setText(data.getNickname());
        holder.tv2.setText((Double)data.getDistance()+"km");
        holder.tv3.setText(data.getTime());
        holder.tv4.setText(data.getStarchar());

        if(data.getSex().equals("男")){
            holder.tv5.setText(" "+data.getAge()+" ");
//            holder.tv5.setSelected(true);
//            holder.tv5.setBackgroundResource(R.drawable.conner_man_bg);
...
//            holder.tv5.setSelected(false);
            holder.tv5.setText(" "+data.getAge()+" ");
//            holder.tv5.setBackgroundResource(R.drawable.conner_women_bg);
