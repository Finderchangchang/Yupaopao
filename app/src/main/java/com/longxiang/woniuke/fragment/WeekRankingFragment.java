...
public class WeekRankingFragment extends Fragment{
    ...
    private List<WeekRankData.DataBean> weekdata=new ArrayList<>();
...
//    private PullToRefreshScrollView mPullRefreshScrollView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.week_ranking_fragment,null);
        setView(view);
        getRankList();
        return view;
    }
    private void getRankList() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                WeekRankData data=new Gson().fromJson(result,WeekRankData.class);
                if(data.getData().size()>=1){
                    WeekRankData.DataBean data01 = data.getData().get(0);
                    layou01.setVisibility(View.VISIBLE);
                    showFirst(data01);
                }
                if(data.getData().size()>=2){
                    WeekRankData.DataBean data02 = data.getData().get(1);
                    layou02.setVisibility(View.VISIBLE);
                    showFirst02(data02);
                }
                if(data.getData().size()>=3){
                    WeekRankData.DataBean data03 = data.getData().get(2);
                    layou03.setVisibility(View.VISIBLE);
                    showFirst03(data03);
                }
                if(data.getData().size()>3){
                    for (int i=3;i<data.getData().size();i++){
                        weekdata.add(data.getData().get(i));
                    }
                    listView.setAdapter(new WeekRankingAdapter(getActivity(),weekdata));
                }
            }
    ...
    private void showFirst03(WeekRankData.DataBean data03) {
        ...
        jifen03.setText(data03.getWeekrank());
        jifen03.setTextColor(Color.parseColor("#1EBAF3"));
    }

    private void showFirst02(WeekRankData.DataBean data02) {
        ...
        jifen02.setText(data02.getWeekrank());
        jifen02.setTextColor(Color.parseColor("#1EBAF3"));
    }

    private void showFirst(WeekRankData.DataBean data01) {
        ...
        jifen01.setText(data01.getWeekrank());
        jifen01.setTextColor(Color.parseColor("#1EBAF3"));
    }

    private void setView(View view) {
        icon01= (ImageView) view.findViewById(R.id.week_ranking_iv_icon01);
        icon02= (ImageView) view.findViewById(R.id.week_ranking_iv_icon02);
        icon03= (ImageView) view.findViewById(R.id.week_ranking_iv_icon03);
        name01= (TextView) view.findViewById(R.id.week_ranking_tv_name01);
        name02= (TextView) view.findViewById(R.id.week_ranking_tv_name02);
        name03= (TextView) view.findViewById(R.id.week_ranking_tv_name03);
        age01= (TextView) view.findViewById(R.id.week_ranking_tv_age01);
        age02= (TextView) view.findViewById(R.id.week_ranking_tv_age02);
        age03= (TextView) view.findViewById(R.id.week_ranking_tv_age03);
        jifen01= (TextView) view.findViewById(R.id.week_ranking_tv_jifen01);
        jifen02= (TextView) view.findViewById(R.id.week_ranking_tv_jifen02);
        jifen03= (TextView) view.findViewById(R.id.week_ranking_tv_jifen03);
//        mPullRefreshScrollView= (PullToRefreshScrollView) view.findViewById(R.id.week_ranking_scrollview);
...
//        mPullRefreshScrollView.getLoadingLayoutProxy().setReleaseLabel("释放开始加载");
        listView= (ListView) view.findViewById(R.id.week_ranking_listview);
        listView.setFocusable(false);
        layou01= (LinearLayout) view.findViewById(R.id.week_ranking_iv_layout01);
        layou02= (LinearLayout) view.findViewById(R.id.week_ranking_iv_layout02);
        layou03= (LinearLayout) view.findViewById(R.id.week_ranking_iv_layout03);
