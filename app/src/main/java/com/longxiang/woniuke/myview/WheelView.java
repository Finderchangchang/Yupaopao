...
public class WheelView extends View {
	 ...
	 * 选锟斤拷锟斤拷 锟斤拷锟斤拷锟酵底诧拷锟斤拷色锟角斤拷锟斤拷模锟斤拷锟斤拷锟街革拷锟揭伙拷锟斤拷锟斤拷锟缴拷锟斤拷锟斤拷锟?
	 */
	 ...
	 * 锟接猴拷锟斤拷getDesiredHeight() 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟街涤︼拷锟斤拷锟狡斤拷指锟矫恳伙拷锟窖★拷锟侥★拷 </br>
	 * 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟叫撅拷桑锟斤拷锟斤拷锟斤拷锟斤拷锟揭伙拷锟斤拷芎停锟揭诧拷锟斤拷锟斤拷锟?锟斤拷锟缴硷拷锟筋，锟斤拷么每锟斤拷锟缴硷拷锟斤拷母锟斤拷痈呔锟斤拷锟?ADDITIONAL_ITEM_HEIGHT/5
	 */
	 ...
	 * &nbsp; 锟斤拷锟斤拷锟借定锟斤拷值锟斤拷锟斤拷锟斤拷指锟斤拷锟节碉拷锟斤拷size锟斤拷锟斤拷锟斤拷锟侥拷锟街?TEXT_SIZE / 5 锟斤拷锟节碉拷锟斤拷1/5锟斤拷锟街猴拷 (锟斤拷么锟斤拷位也应锟斤拷锟斤拷sp锟斤拷)
	 */
	 ...
	 * 
	 *  </br>
	 * 锟斤拷锟斤拷锟斤拷占洌?锟斤拷锟斤拷锟絶~锟斤拷锟斤拷锟斤拷锟皆帮拷 </br>
	 ...
	 *  </br>
	 * 锟斤拷锟? </br>
	 * 锟斤拷锟窖★拷锟斤拷锟节诧拷锟斤拷洌拷锟斤拷选锟斤拷锟角革拷TextView锟侥伙拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟矫的硷拷锟斤拷TextView锟斤拷锟斤拷锟?</br>
	 * =锟斤拷=锟斤拷锟斤拷锟斤拷锟斤拷牖癸拷锟斤拷锌锟斤拷锟絠tem锟斤拷啥锟斤拷也锟斤拷知锟斤拷
	 */
	 ...
	 * 
	 *  </br>
	 * 默锟较可硷拷锟斤拷锟斤拷锟侥匡拷锟斤拷锟斤拷锟絧icker锟斤拷锟斤拷示锟斤拷锟斤拷
	 */
	...
	private void initData(Context context) {
		...
		gestureDetector.setIsLongpressEnabled(false); //锟斤拷锟矫伙拷锟斤拷锟斤拷锟斤拷锟绞裁达拷茫锟斤拷锟斤拷锟斤拷茫锟斤拷锟斤拷锟斤拷贸锟絫rue锟斤拷锟斤拷影锟斤拷效锟斤拷
	 ...
	 *
	 * </br>
	 * 锟斤拷锟斤拷也锟斤拷锟斤拷锟斤拷 锟斤拷锟斤拷陌桑锟斤拷锟酵拷锟斤拷锟斤拷锟斤拷宀癸拷锟斤拷锟绞碉拷锟?锟斤拷锟斤拷锟斤拷锟?
	 */
	 ...
	 * 锟斤拷锟斤拷锟絪crollingOffset 锟斤拷没锟斤拷锟斤拷锟斤拷锟斤拷什么锟矫ｏ拷
	 */
	 ...
	 * 锟斤拷锟斤拷锟叫╋拷锟揭拷锟斤拷锟轿拷盏幕锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷应锟斤拷锟斤拷锟剿筹拷始锟斤拷锟斤拷锟斤拷锟斤拷
	 */
	 ...
	 * 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟轿э拷锟斤拷丶锟斤拷植锟斤拷锟窖拷锟斤拷模锟絠sCyclic锟斤拷锟斤拷锟津返伙拷null </br>
	 * 锟斤拷锟斤拷锟窖拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟节诧拷锟斤拷锟斤拷锟剿达拷锟斤拷 </br>
	 ...
	 * 锟斤拷锟絞etTextItem(i)锟斤拷锟斤拷null, 锟津不伙拷锟津返伙拷值锟斤拷追锟斤拷
	 */
	...
	private int getMaxTextLength() {
		...
		}//锟斤拷锟窖拷锟斤拷姆锟轿伙拷锟斤拷锟斤拷锟窖斤拷锟斤拷锟绞贾碉拷锟斤拷锟斤拷锟窖拷锟斤拷锟?锟斤拷锟斤拷为什么锟斤拷 锟斤拷前锟斤拷锟斤拷锟斤拷+锟缴硷拷锟斤拷目锟斤拷锟斤拷
	...
	private int getItemHeight() {
		if (itemHeight != 0) {
			...
			return itemHeight;
		}//锟斤拷锟斤拷锟絠temlayout 为什么要锟斤拷 锟斤拷锟斤拷锟叫碉拷top锟斤拷锟斤拷一锟叫碉拷top锟截ｏ拷锟斤拷锟斤拷应锟矫凤拷锟斤拷layout锟侥革拷锟斤？没锟斤拷锟斤拷锟斤拷
	 ...
	 * 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟轿拷眨锟斤拷锟組otionEvent锟斤拷锟捷革拷锟斤拷锟斤拷识锟斤拷锟斤拷锟斤拷 锟斤拷锟叫讹拷锟角凤拷锟斤拷ACTION_UP </br>
	 ...
	 * 
	 * </br>
	 * 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟絘nimationHandler锟叫碉拷原锟斤拷锟斤拷息锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷息
	 */
	 ...
	 * 
	 * </br>
	 * 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟皆拷械锟斤拷锟较?
	 */
