...
public class MyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            MyApp.deviceId=regId;
            SharedPreferences prefs=context.getSharedPreferences("deviceId",Context.MODE_PRIVATE);
...
//                if (info.topActivity.getPackageName().equals("com.longxiang.woniuke") && info.baseActivity.getPackageName().equals("com.longxiang.woniuke")) {
//                    isAppRunning = true;
//                    break;
//                }
//            }
