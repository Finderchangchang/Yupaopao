 ...
 */
public class ZanpeopleAdapter extends BaseAdapter{
    private Context context;
    private List<ZanpeopleData.DataBean> list;
    private LayoutInflater inflater;
    public ZanpeopleAdapter(Context context, List<ZanpeopleData.DataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView=inflater.inflate(R.layout.zan_pepole_item,null);
            holder.tvname= (TextView) convertView.findViewById(R.id.zan_people_item_name);
            holder.ivpic= (ImageView) convertView.findViewById(R.id.zan_people_item_icon);
            holder.tvsex= (TextView) convertView.findViewById(R.id.zan_people_item_sex);
