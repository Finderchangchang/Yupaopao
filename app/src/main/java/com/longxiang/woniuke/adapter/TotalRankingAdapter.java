...
public class TotalRankingAdapter extends BaseAdapter {
    ...
    private List<TotalRankingData.DataBean> datas;
    private final ImageOptions options=new ImageOptions.Builder()
            ...
            .setIgnoreGif(false)
            .build();
    public TotalRankingAdapter(Context context, List<TotalRankingData.DataBean> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TotalRankingData.DataBean data=datas.get(position);
        ...
        holder.tvjifen.setText(data.getAllrank());
