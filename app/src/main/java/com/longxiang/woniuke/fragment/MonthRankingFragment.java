...
import com.longxiang.woniuke.adapter.MonthRankingAdapter;
import com.longxiang.woniuke.bean.MonthRankData;
...
public class MonthRankingFragment extends Fragment {
    ...
    private List<MonthRankData.DataBean> monthdata=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.month_ranking_fragment,null);
        setView(view);
        getRankList();
        return view;
    }
    private void getRankList() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                MonthRankData data=new Gson().fromJson(result,MonthRankData.class);
                if(data.getData().size()>=1){
                    MonthRankData.DataBean data01 = data.getData().get(0);
                    layou01.setVisibility(View.VISIBLE);
                    showFirst(data01);
                }
                if(data.getData().size()>=2){
                    MonthRankData.DataBean data02 = data.getData().get(1);
                    layou02.setVisibility(View.VISIBLE);
                    showFirst02(data02);
                }
                if(data.getData().size()>=3){
                    MonthRankData.DataBean data03 = data.getData().get(2);
                    layou03.setVisibility(View.VISIBLE);
                    showFirst03(data03);
                }
                if(data.getData().size()>3){
                    for (int i=3;i<data.getData().size();i++){
                        monthdata.add(data.getData().get(i));
                    }
                    listView.setAdapter(new MonthRankingAdapter(getActivity(),monthdata));
                }
            }
    ...
    private void showFirst03(MonthRankData.DataBean data03) {
        ...
        jifen03.setText(data03.getMonthrank());
        jifen03.setTextColor(Color.parseColor("#1EBAF3"));

    }

    private void showFirst02(MonthRankData.DataBean data02) {
        ...
        jifen02.setText(data02.getMonthrank());
        jifen02.setTextColor(Color.parseColor("#1EBAF3"));
    }

    private void showFirst(MonthRankData.DataBean data01) {
        ...
        Log.i("monthrank", "showFirst: "+data01.getMonthrank());
        jifen01.setText(data01.getMonthrank());
        jifen01.setTextColor(Color.parseColor("#1EBAF3"));
    }

    private void setView(View view) {
        icon01= (ImageView) view.findViewById(R.id.month_ranking_iv_icon01);
        icon02= (ImageView) view.findViewById(R.id.month_ranking_iv_icon02);
        icon03= (ImageView) view.findViewById(R.id.month_ranking_iv_icon03);
        name01= (TextView) view.findViewById(R.id.month_ranking_tv_name01);
        name02= (TextView) view.findViewById(R.id.month_ranking_tv_name02);
        name03= (TextView) view.findViewById(R.id.month_ranking_tv_name03);
        age01= (TextView) view.findViewById(R.id.month_ranking_tv_age01);
        age02= (TextView) view.findViewById(R.id.month_ranking_tv_age02);
        age03= (TextView) view.findViewById(R.id.month_ranking_tv_age03);
        jifen01= (TextView) view.findViewById(R.id.month_ranking_tv_jifen01);
        jifen02= (TextView) view.findViewById(R.id.month_ranking_tv_jifen02);
        jifen03= (TextView) view.findViewById(R.id.month_ranking_tv_jifen03);
...
//        mPullRefreshScrollView.getLoadingLayoutProxy().setReleaseLabel("释放开始加载");
        listView= (ListView) view.findViewById(R.id.month_ranking_listview);
        listView.setFocusable(false);
        layou01= (LinearLayout) view.findViewById(R.id.month_ranking_iv_layout01);
        layou02= (LinearLayout) view.findViewById(R.id.month_ranking_iv_layout02);
        layou03= (LinearLayout) view.findViewById(R.id.month_ranking_iv_layout03);
    }
}
