 ...
 */
public class MonthRankingAdapter extends BaseAdapter {
    private Context context;
    private List<MonthRankData.DataBean> datas;
    private final ImageOptions options=new ImageOptions.Builder()
            ...
            .setIgnoreGif(false)
            .build();
    public MonthRankingAdapter(Context context, List<MonthRankData.DataBean> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MonthRankData.DataBean data=datas.get(position);
        ...
        holder.tvjifen.setText(data.getMonthrank());
